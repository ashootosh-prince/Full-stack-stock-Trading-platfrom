        ...
        <div className='container mt-5'>
            <div className='row mt-5'>
                <div className='col' style={{ fontSize: "14px"}}>
                    ...
                    <p className='mt-3 text-muted'>&copy; 2010 - 2024, Zerodha Broking Ltd.</p>
                ...
                <div className=' footer-link col'>
                    <p>Support</p>
                    <a className='mb-3' href=''>Contact us</a>
                    <br/>
            ...
            <div className='mt-5 mb-5 text-muted' style={{ fontSize: "14px", textDecoration:"none"}}>
            ...
            <br/>
            <a style={{textDecoration:"none"}} href=''>Smart Online Dispute Resolution</a> | <a style={{textDecoration:"none"}} href=''>Grievances Redressal Mechanism</a>
